...
class Goblin(pygame.sprite.Sprite):
    ...
    def animate(self):
        if self.facing == 'down':
            if self.y_change == 0:
                self.image = self.goblin_walking_spritesheet.get_sprite(0, 0, self.width, self.height)
            else:
        ...
        if self.facing == 'up':
            if self.y_change == 0:
                self.image = self.goblin_walking_spritesheet.get_sprite(0, 128, self.width, self.height)
            else:
        ...
        if self.facing == 'left':
            if self.x_change == 0:
                self.image = self.goblin_walking_spritesheet.get_sprite(0, 192, self.width, self.height)
            else:
                if not self.inCombat:
        ...
        if self.facing == 'right':
            if self.x_change == 0:
                self.image = self.goblin_walking_spritesheet.get_sprite(0, 64, self.width, self.height)
            else:
